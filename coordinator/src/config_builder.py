...
class ConfigBuilder:
    ...
    def __init__(
        ...
        *,
        ...
        http_tls: bool = False,
        target: str = "all",
        s3_config_data: Optional[_S3ConfigData],
    ):
        """Init method."""
        ...
        self._target = target
        self._s3_config_data = s3_config_data
    ...
    def _common(self) -> Dict[str, Any]:
        ...
        if self._s3_config_data:
            storage = {"s3": self._s3_config_data.model_dump()}
    ...
    @property
    def _ingester(self) -> Dict[str, Any]:
        return {
            "wal": {
    ...
    @property
    def _limits_config(self) -> Dict[str, Any]:
    ...
    @property
    def _query_range(self) -> Dict[str, Any]:
    ...
    @property
    def _frontend(self) -> Dict[str, Any]:
    ...
    @property
    def _querier(self) -> Dict[str, Any]:
    ...
    @property
    def _compactor(self) -> Dict[str, Any]:
